...
- **ZERO inline comments** (project enforces strict no-comments rule)
- **ZERO block comments** — documentation via docstrings only
- Flag any `# TODO`, `# FIXME`, `# HACK` as violations
